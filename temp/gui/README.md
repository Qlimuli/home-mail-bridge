...
**Dashboard** (Startseite): Service-Status (supervisorctl), Anzahl Konten/Aliase,
Postfix-Warteschlange, Mail-Speicher, grobe Gesendet/Empfangen-Zählung aus den Logs,
Schnellzugriff auf alle Verwaltungsfunktionen – in etwa wie eine MailPlus-Übersicht.
